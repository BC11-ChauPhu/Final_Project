			...
			<div className=" pb-6 md:pl-6 xl:pl-20">
				...
				>
					<div className={`${id && !isNaN(Number(id)) ? "md:mr-6" : ""} pb-6`}>
						...
						<div
							className={`grid gap-6 xl:gap-10 ${isNaN(Number(id)) ? "lg:grid-cols-3 xl:grid-cols-5" : "lg:grid-cols-2"} grid-cols-1 md:grid-cols-2`}
						>
							{location?.map((item, index) => (
								<div key={index}>
									<div className="locationItem flex flex-col gap-3">
										...
										>
											<SwiperSlide
												className={` ${isNaN(Number(id)) ? "h-64" : "h-56 xl:h-80"}`}
											>
